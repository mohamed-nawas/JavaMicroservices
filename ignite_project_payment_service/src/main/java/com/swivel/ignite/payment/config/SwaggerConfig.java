...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.swivel.ignite.payment"))
    ...
    private ApiInfo generateAPIInfo() {
        return new ApiInfo("Ignite Payment Service", "Implementing Swagger with SpringBoot Application",
